...
namespace Play.Identity.Service.HostedServices
{
    public class IdentitySeedHostedService : IHostedService
    {
        ...
        public IdentitySeedHostedService(IServiceScopeFactory serviceProvider, IOptions<IdentitySettings> identityOptions)
        {
        ...
        public Task StopAsync(CancellationToken cancellationToken) => Task.CompletedTask; // nothing to do here
